...
public class HostelQuotePrice extends HostelView {
	...
	public void priceList() {
		...
		Select guest = new Select(driver.findElement(By.xpath("/html/body/app-root/app-guest-index/app-detailview/div[1]/div/div[3]/div/table/tbody/tr/td[3]/div/select")));
		guest.selectByIndex(1);
		driver.findElement(By.xpath("//button[contains(text(), 'Quote Price')]")).click();
		Select floor = new Select(driver.findElement(By.xpath("/html/body/app-root/app-guest-index/app-detailview/div[1]/div/div[2]/div/div[2]/select")));
		floor.selectByIndex(2);
		driver.findElement(By.xpath("//a[contains(text(),'201')]")).click();
		Select guest1 = new Select(driver.findElement(By.xpath("/html/body/app-root/app-guest-index/app-detailview/div[1]/div/div[3]/div/table/tbody/tr/td[3]/div/select")));
